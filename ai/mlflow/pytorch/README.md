...
pumpkin-mlflow-pytorch
sudo docker build -t pumpkin-mlflow-pytorch:1.0 -f ./Dockerfile .
sudo docker build -t pumpkin-mlflow-pytorch-notebook:1.0 -f ./Dockerfile.lab .

sudo docker tag pumpkin-mlflow-pytorch:1.0 yiluxiangbei/pumpkin-mlflow-pytorch:1.0
sudo docker push yiluxiangbei/pumpkin-mlflow-pytorch:1.0

sudo docker tag pumpkin-mlflow-pytorch:1.0 registry.cn-beijing.aliyuncs.com/luomor/pumpkin-mlflow-pytorch:1.0
sudo docker push registry.cn-beijing.aliyuncs.com/luomor/pumpkin-mlflow-pytorch:1.0

sudo docker tag pumpkin-mlflow-pytorch-notebook:1.0 yiluxiangbei/pumpkin-mlflow-pytorch-notebook:1.0
sudo docker push yiluxiangbei/pumpkin-mlflow-pytorch-notebook:1.0

sudo docker tag pumpkin-mlflow-pytorch-notebook:1.0 registry.cn-beijing.aliyuncs.com/luomor/pumpkin-mlflow-pytorch-notebook:1.0
sudo docker push registry.cn-beijing.aliyuncs.com/luomor/pumpkin-mlflow-pytorch-notebook:1.0
```
